...
<div class="d-flex flex-wrap">
    ...
    <div class="flex-shrink-0 flex-grow-2 text-start ">
        ...
        <ul class="text-start d-inline-block ps-0">
            <li><a href="https://discord.gg/EBF8EUN2RK" target="_blank" rel="noreferrer"><img src="/discord_icon.png" class="icon"/> Join us on Discord</a></li>
            <li><a href="https://www.instagram.com/urbanistportland.me/" target="_blank" rel="noreferrer"><img src="/instagram_icon.png" class="icon"/>Follow us on Instagram</a></li>
            <li><a href="https://www.facebook.com/profile.php?id=100093333520448" target="_blank" rel="noreferrer"><img src="/facebook_icon.png" class="icon"/>Like us on Facebook</a></li>
            <li><a href="https://twitter.com/urbanistport_me" target="_blank" rel="noreferrer"><img src="/twitter_icon.png" class="icon"/>Follow us on Twitter</a></li>
        </ul>
    </div>
</div>
